...
class LwdHistory {
    ...
    String _create_table =
            "CREATE TABLE IF NOT EXISTS " + _table_name + "(" +
                    ...
                    _data_repeater + " TEXT DEFAULT '0000', " + _user_latitude + " REAL, " + _user_longitude + " REAL, " +
